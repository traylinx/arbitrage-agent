...
def build_worker_env(
    ...
    for source_key, target_key in (
        ...
        ("BTC_LAB_EXPLORATION_MIN_EDGE", "BTC_EXPLORATION_MIN_EDGE"),
        ("BTC_LAB_EXPLORATION_MIN_CONF", "BTC_EXPLORATION_MIN_CONF"),
        ("BTC_LAB_EXPLORATION_MIN_POLY", "BTC_EXPLORATION_MIN_POLY"),
        ("BTC_LAB_EXPLORATION_MAX_POLY", "BTC_EXPLORATION_MAX_POLY"),
        ("BTC_LAB_EXPLORATION_MAX_SPEND", "BTC_EXPLORATION_MAX_SPEND"),
        ("BTC_LAB_EXPLORATION_DELTA_FLOOR", "BTC_EXPLORATION_DELTA_FLOOR"),
        ("BTC_LAB_EXPLORATION_MAX_SLIPPAGE_BPS", "BTC_EXPLORATION_MAX_SLIPPAGE_BPS"),
        ("BTC_LAB_PAPER_EXPLORATION_FORCE", "BTC_PAPER_EXPLORATION_FORCE"),
    ):
